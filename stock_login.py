...
class login_system:
    def __init__(self,root):
        ...
        btn_log=Button(Login_Frame,command=self.login,text="Login",width=15,font=("times new roman",14,"bold"),bg="yellow",fg="red")
        btn_log.grid(row=3,column=1,pady=10)
        # btn_log.bind
        btn_log.bind("<Return>",self.login)
        btn_log.bind("<Button-1>",self.login)
